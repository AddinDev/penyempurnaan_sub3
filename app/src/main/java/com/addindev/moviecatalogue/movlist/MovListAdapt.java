...
public class MovListAdapt extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<ItemResult> itemList;

    private OnItemClickListener mItemClickListener;

    public MovListAdapt(List<ItemResult> itemList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            final ItemResult model = getItem(position);
    ...
    public interface OnItemClickListener {
        ...
        void onItemClick(View view, ItemResult model);
